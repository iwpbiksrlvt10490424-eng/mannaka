...
class MidpointService {
  ...
  /// お好み焼きは個別表記ブレと大手チェーン名でも除外する（カテゴリだけだと
  /// 捕捉しきれず、実機で「カフェ選択でも まだお好み焼きが出る」との指摘あり）。
  static const Set<String> _kCafeNameExclusions = {
    // ジャンル語
    'お好み焼き', 'お好み焼', 'おこのみ焼', 'おこのみやき',
    'もんじゃ', 'モンジャ',
    '鉄板焼', '鉄板料理', 'てっぱん',
    '焼肉', '焼き肉', '韓国焼肉',
    'ラーメン', '麺屋', '担々麺', 'つけ麺',
    '居酒屋', '酒場', 'ホルモン',
    // お好み焼きの大手チェーン（名前にジャンル語が含まれないもの）
    '道とん堀', '千房', 'ぼてぢゅう', '風月', 'きん太', 'つるとんたん',
    '鶴橋風月', '元祖ぢゅうぢゅう', '五エ門',
    // カジュアル居酒屋チェーン誤爆
    '鳥貴族', '塚田農場', '庄や',
  };
