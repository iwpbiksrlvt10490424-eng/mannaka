          ...
          sections: [
            ...
            _PolicySection(
              ...
              content:
                  ...
                  '取り扱い：本機能はデフォルトで有効（ON）です。無効化（オプトアウト）をご希望の場合は、'
                  '第8条のお問い合わせ窓口までご連絡ください。'
                  '氏名・メール等の個人識別情報は送信せず、'
          ...
          sections: [
            ...
            _PolicySection(
              ...
              content:
                  ...
                  '１　法令または公序良俗に違反する行為\n'
                  '２　犯罪行為に関連する行為\n'
                  '３　当アプリ、他のユーザー、または第三者のサーバーやネットワークに過度な負荷をかける行為\n'
                  '４　当アプリのサービス運営を妨害するおそれのある行為\n'
                  '５　他のユーザーに関する個人情報等を収集または蓄積する行為\n'
                  '６　不正アクセスをし、またはこれを試みる行為\n'
                  '７　当アプリのシステムをリバースエンジニアリング、逆コンパイル、逆アセンブルする行為\n'
                  '８　本サービスを商業目的で無断利用する行為\n'
                  '９　その他、当アプリが不適切と判断する行為',
            ),
            _PolicySection(
              title: '第5条（知的財産権）',
              content:
