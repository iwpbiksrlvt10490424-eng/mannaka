...
//   虚偽記載扱いとなり得るため、Cycle 5 の前例に倣い 2026年5月10日 に更新する。
//
// 受け入れ条件（C1〜C7）:
//   C1: プライバシーポリシーの最終改定日が「2026年5月10日」であること
...
void main() {
  ...
  group('policy_screen — プライバシーポリシー最終改定日', () {
    test('[C1] プライバシーポリシーの最終改定日が 2026年5月10日 のとき正しい改定日になる', () {
      final content = _readPolicySource();

      final hasCorrectDate = content.contains('最終改定日：2026年5月10日');

      expect(
        hasCorrectDate,
        isTrue,
        reason: 'プライバシーポリシーの最終改定日が 2026年5月10日 ではありません。\n'
            'header の「最終改定日：2026年4月21日」を「最終改定日：2026年5月10日」に更新してください。\n'
    ...
    test('[C3] Cycle 5 以前の改定日（2026年4月10日）がプライバシーポリシーに残っていないとき回帰していない', () {
      ...
      expect(
        ...
        reason: 'Cycle 5 以前の改定日「2026年4月10日」が残っています。\n'
            '「2026年5月10日」のみがプライバシーポリシーの改定日として残るようにしてください。\n'
            '違反箇所:\n${violations.join('\n')}',
      );
    });
    ...
    test('[C4] プライバシーポリシーのヘッダーに制定日（2024年4月1日）が含まれているとき制定日が維持されている', () {
      ...
      expect(
        ...
        reason: 'プライバシーポリシーのヘッダーに制定日（2024年4月1日）が含まれていません。\n'
            'ヘッダーは「制定日：2024年4月1日」と「最終改定日：2026年5月10日」の両方を含む必要があります。',
      );
    });
    ...
    test('[C6] プライバシーポリシーのヘッダーが Aimachi ブランド + 制定日 + 最終改定日 2026年5月10日 の組合せのとき完全一致する', () {
      final content = _readPolicySource();
